...
export const defaultSEO: SEOConfig = {
  title: 'NgernNgern ThongThong - ระบบบันทึกรายรับรายจ่าย',
  description: 'ระบบบันทึกรายรับรายจ่ายส่วนบุคคล ติดตามการเงินของคุณได้ทุกที่ ทั้งรายรับและรายจ่ายแบบง่ายๆ',
  keywords: [
    'รายรับรายจ่าย',
    'บันทึกการเงิน',
    'การเงินส่วนบุคคล',
